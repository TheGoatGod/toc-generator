...
describe('main', () => {
  ...
  it('should close pull request', async() => {
    ...
    stdoutCalledWith(mockStdout, [
      ...
      '  >> stdout',
      '> Running commands...',
      '[command]DocToccing single file "[Working Directory]/**.create1.md".',
      '[command]DocToccing single file "[Working Directory]/**.create2.md".',
      '[command]DocToccing single file "[Working Directory]/**.horizontal.md".',
      '[command]DocToccing single file "[Working Directory]/**.not.update.md".',
      '[command]DocToccing single file "[Working Directory]/**.params.md".',
      '[command]DocToccing single file "[Working Directory]/**.toc-me.md".',
      '[command]DocToccing single file "[Working Directory]/**.update.md".',
      '[command]Run doctoc',
      '  >> changed:',
      '  >>   - [Working Directory]/**.create1.md',
      '  >>   - [Working Directory]/**.create2.md',
      '  >>   - [Working Directory]/**.horizontal.md',
      '  >>   - [Working Directory]/**.params.md',
      '  >>   - [Working Directory]/**.toc-me.md',
      '  >>   - [Working Directory]/**.update.md',
      '  >> unchanged:',
      '  >>   - [Working Directory]/**.not.update.md',
      '> Checking diff...',
      '[command]git add --all',
      '  >> stdout',
